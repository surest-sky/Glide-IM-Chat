...
import { register } from 'src/api/chat/app';
            ...
            <section className="flex flex-col md:flex-row h-screen items-center">
                ...
                >
                    <div className="w-full h-100">
                        <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">注册</h1>
                        <Form className="mt-6" wrapperCol={{ span: 24 }} form={form}>
                            ...
                            <FormItem field={'captcha'} rules={[
                                ...
                                <AuthVerifyCode mode={"register"} validate={validateAllowCode} getValue={() => form.getFieldValue("email")} />
                            </FormItem>
